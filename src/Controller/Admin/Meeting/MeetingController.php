...
//    #[Route(name: 'adminold_meeting_index', methods: ['GET'])]
...
//    #[Route('/create', name: 'adminold_meeting_create', methods: ['POST'])]
...
//            return $this->redirectToRoute('adminold_meeting_index', [], Response::HTTP_SEE_OTHER);
//        }
//
//        $meetingId = $meetingCreator->createMeeting($meetingType);
//
//        return $this->redirectToRoute(
//            'adminold_meeting_add_participant',
//            ['id' => $meetingId],
//            Response::HTTP_SEE_OTHER
//        );
//    }

//    #[Route('/{id}/add-participants', name: 'adminold_meeting_add_participant', methods: ['GET', 'POST'])]
...
//
//                return $this->redirectToRoute('adminold_meeting_show', ['id' => $meeting->getId()], Response::HTTP_SEE_OTHER);
//            }
//
...
//    #[Route('/{id}/edit', name: 'adminold_meeting_edit', methods: ['GET', 'POST'])]
...
//
//            return $this->redirectToRoute('adminold_meeting_show', [
//                'id' => $meeting->getId()
//            ]);
//        }
